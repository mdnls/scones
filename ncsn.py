...
def parse_args_and_config():
    ...
    args.log_path = os.path.join('ncsn', args.exp, 'logs', args.doc)
    ...
    tb_path = os.path.join('ncsn', args.exp, 'tensorboard', args.doc)
...
def main():
    ...
    try:
        ...
        if args.test:
            ...
            logging.info("You are sampling via ncsn.py, which does not incorporate SCONES or optimal transport.")
            runner.sample()
        elif args.fast_fid:
            runner.fast_fid()
        else:
